...
import mg.studio.game.animals.BToast;
public class PlayActivity extends AppCompatActivity {
    ...
    public void btnClick(View view) {
        ...
        if (animalToFind.equals(nameOfImagesUsed.get(Integer.valueOf(view.getTag().toString())))) {
            ...
            BToast.showText(this, "You are correct!", true);
            ...
            if(score==8){
                BToast.showText(this, "Congratulations for finishing all challenges!", Toast.LENGTH_LONG);
                finish();
            }
